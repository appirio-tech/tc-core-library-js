...
module.exports = function(config) {
  let auth0Url = _.get(config, 'auth0Url', 'https://topcoder-newauth.auth0.com/oauth/token')
  let auth0Audience = _.get(config, 'auth0Audience', 'https://www.topcoder.com')
  let tokenCacheTime = _.get(config, 'tokenCacheTime', ONE_DAY_TIMEMILIS)
